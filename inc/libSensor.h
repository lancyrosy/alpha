...
extern volatile int16_t sensor[NUM_SENSOR];		// actual sensor values
extern volatile int16_t sensorOld[NUM_SENSOR];
extern volatile int sensoroffset, sensoroffsetX2, sensoroffset2, sensoroffsetold, senfla, cenval;
